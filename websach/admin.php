...
<body>
                ...
                <div class="admin-control">
                    ...
                    <div class="admin-control-center">
                        <form action="" class="form-search">
                            ...
                            <input id="form-search-product" type="text" class="form-search-input" placeholder="Tìm kiếm các loại sách ..." oninput="showProduct()">
                        </form>
                    </div>
                    ...
                    <div class="settings-card">
                        ...
                        <div class="settings-form">
                            ...
                            <div class="form-group duration-group">
                                <label class="form-label">Thời hạn mã giảm giá</label>
                                <div class="duration-inputs">
                                    <div class="duration-item">
                                        <input type="number" id="coupon-duration-hours" class="form-control" placeholder="0" min="0" value="0">
                                        <span class="duration-label">Giờ</span>
                                    </div>
                                    <div class="duration-item">
                                        <input type="number" id="coupon-duration-minutes" class="form-control" placeholder="30" min="0" value="30">
                                        <span class="duration-label">Phút</span>
                                    </div>
                                    <div class="duration-item">
                                        <input type="number" id="coupon-duration-seconds" class="form-control" placeholder="0" min="0" value="0">
                                        <span class="duration-label">Giây</span>
                                    </div>
                                </div>
                                <p class="duration-note">* Chỉ cho phép tối đa 2 trường bằng 0. Không được phép cả 3 trường đều bằng 0.</p>
                            </div>
    ...
    <script src="./js/tongquan.js?v=3"></script>
